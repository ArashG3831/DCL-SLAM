...
class Generator:public rclcpp::Node {
 ...
 struct Work{frontier_exploration_ros2::FrontierCandidate region;uint64_t id{0};double frontier_length{0},gain{0},euclid{0},heading{0};std::array<double,4> bounds{};geometry_msgs::msg::PoseStamped pose;double path{0},score{0};};

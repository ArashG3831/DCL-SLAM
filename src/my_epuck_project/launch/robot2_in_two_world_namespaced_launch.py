...
def _launch_setup(context):
    ...
    diffdrive_controller_spawner = Node(
        ...
        parameters=[{
            ...
            'controller_manager': '/robot2/controller_manager',
            'controller_param_file': '/tmp/my_epuck_project_robot2_ros2_control.yml',
            'switch_timeout_s': 10.0,
            'controller_ros_args': (
                '--ros-args --remap /robot2/diffdrive_controller/odom:=/robot2/odom '
                '--remap /robot2/diffdrive_controller/cmd_vel:=/robot2/cmd_vel '
                '--param tf_frame_prefix:=robot2/'),
        }],
    )
    ...
    joint_state_broadcaster_spawner = Node(
        ...
        parameters=[{
            ...
            'switch_timeout_s': 10.0,
            'controller_ros_args': (
                '--ros-args --remap /joint_states:=/robot2/joint_states '
                '--remap /dynamic_joint_states:=/robot2/dynamic_joint_states'),
        }],
    )

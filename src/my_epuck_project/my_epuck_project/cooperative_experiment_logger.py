...
from my_epuck_interfaces.msg import ExplorationClaim, FrontierCandidateArray, PeerMap
...
SCHEMA='1.0.0'; STATES={0:'UNKNOWN',1:'PROPOSING',2:'NAVIGATING',3:'SUCCEEDED',4:'FAILED',5:'RELEASED',6:'CANCELED'}

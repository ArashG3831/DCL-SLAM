...
CONSERVATIVE_SCAN_MATCHING_PARAMETERS = {
    ...
    # The corrected D500 bridge publishes one scan per simulated second.  The
    # SLAM throttle therefore remains one: a value of ten would silently
    # discard nine out of every ten corrected scans and reduce scan matching
    # to roughly 0.1 Hz.
    'throttle_scans': 1,
    'minimum_time_interval': 1.0,
    # Publish the full 720-beam scan at 1 Hz of simulation time.  This keeps
...
PROFILE_SETTINGS = {
    ...
    'large_unknown_pose_far_start_20ms_scan_matching': {
        'world': 'epuck_d500_two_world_unknown_pose_far_start_dynamic_low_slip_20ms_finite.wbt',
        'baseline_world': 'epuck_d500_two_world_large.wbt',
...
def manual_rviz_path(value, resource_directory):
    """Return the installed passive RViz preset for the selected profile."""
